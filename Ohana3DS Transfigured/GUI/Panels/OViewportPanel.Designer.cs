namespace Ohana3DS_Transfigured.GUI
{
    partial class OViewportPanel
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.VisibilityAnimationsGroup = new Ohana3DS_Transfigured.GUI.OGroupBox();
            this.VisibilityAnimationsPanel = new Ohana3DS_Transfigured.GUI.OAnimationsPanel();
            this.MaterialAnimationsGroup = new Ohana3DS_Transfigured.GUI.OGroupBox();
            this.MaterialAnimationsPanel = new Ohana3DS_Transfigured.GUI.OAnimationsPanel();
            this.SkeletalAnimationsGroup = new Ohana3DS_Transfigured.GUI.OGroupBox();
            this.SkeletalAnimationsPanel = new Ohana3DS_Transfigured.GUI.OAnimationsPanel();
            this.TexturesGroup = new Ohana3DS_Transfigured.GUI.OGroupBox();
            this.TexturesPanel = new Ohana3DS_Transfigured.GUI.OTexturesPanel();
            this.ModelsGroup = new Ohana3DS_Transfigured.GUI.OGroupBox();
            this.ModelsPanel = new Ohana3DS_Transfigured.GUI.OModelsPanel();
